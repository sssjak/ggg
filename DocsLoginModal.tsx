...
const DocsLoginModal: React.FC<DocsLoginModalProps> = ({ onClose, onSubmit, onForgotPasswordClick }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-secondary p-8 rounded-lg shadow-2xl w-full max-w-sm m-4 border border-gray-700">
        <h2 className="text-2xl font-bold text-text-primary mb-4">Access Documents</h2>
        <p className="text-text-secondary mb-6">This section is password protected.</p>
